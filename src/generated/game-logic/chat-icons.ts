 ...
 * Generated on 2025-07-26T21:25:23.235Z
 */

import { z } from 'zod'
import { ChatIconHridEnum, ChatIconSchema, type ChatIcon } from '../schemas/zod/chat-icons.js'
// Re-export HRID enum from schema
export { ChatIconHridEnum } from '../schemas/zod/chat-icons.js'
// Re-export schema
export { ChatIconSchema } from '../schemas/zod/chat-icons.js'

// Type definitions
type ChatIconHrid = z.infer<typeof ChatIconHridEnum>

// Data
export const CHATICONS: Record<ChatIconHrid, ChatIcon> = {
  '/chat_icons/abyssal_imp': {
  ...
  '/chat_icons/chronofrost_sorcerer': {
  ...
  '/chat_icons/costom_rose_3': {
    "hrid": "/chat_icons/costom_rose_3",
    "name": "",
    "isSpecial": false,
    "isSeasonal": false,
    "cowbellCost": 0,
  ...
  '/chat_icons/custom_39moonmantououo': {
  ...
  '/chat_icons/custom_auspiciousdragon': {
  ...
  '/chat_icons/custom_auspiciousdragon_2': {
  ...
  '/chat_icons/custom_auspiciousdragon_3': {
  ...
  '/chat_icons/custom_bigdragonwang': {
  ...
  '/chat_icons/custom_bromothymolblue': {
  ...
  '/chat_icons/custom_dingdingfly_2': {
  ...
  '/chat_icons/custom_golden_hound': {
  ...
  '/chat_icons/custom_goldenhound_2': {
  ...
  '/chat_icons/custom_goldenhound_3': {
  ...
  '/chat_icons/custom_goodguyjack_2': {
  ...
  '/chat_icons/custom_goodguyjack_3': {
  ...
  '/chat_icons/custom_guguguguchicken': {
  ...
  '/chat_icons/custom_hamunekouwuo': {
  ...
  '/chat_icons/custom_hinanaitenshi': {
  ...
  '/chat_icons/custom_immortalphoenix': {
  ...
  '/chat_icons/custom_immortalphoenix_2': {
  ...
  '/chat_icons/custom_immortalphoenix_3': {
  ...
  '/chat_icons/custom_mengmenguwu_2': {
  ...
  '/chat_icons/custom_nishikiasumi': {
  ...
  '/chat_icons/custom_niu1niu2niu3': {
  ...
  '/chat_icons/custom_pharmerphrog': {
  ...
  '/chat_icons/custom_pinkmoolyd_2': {
  ...
  '/chat_icons/custom_scorpionkenzo': {
  ...
  '/chat_icons/custom_sumimiuniverse': {
  ...
  '/chat_icons/custom_sumimiuniverse_2': {
  ...
  '/chat_icons/custom_sumimiuniverse_3': {
  ...
  '/chat_icons/custom_taichislippers': {
  ...
  '/chat_icons/custom_taichislippers_2': {
  ...
  '/chat_icons/custom_temaritsukimura': {
  ...
  '/chat_icons/custom_temaritsukimura_2': {
  ...
  '/chat_icons/custom_thessaloniki': {
  ...
  '/chat_icons/custom_tiantian666_2': {
  ...
  '/chat_icons/custom_wavesperfect': {
  ...
  '/chat_icons/custom_xxnagasakisoyoxx': {
  ...
  '/chat_icons/custom_yurisaisarabbit': {
...
} as const satisfies Record<ChatIconHrid, ChatIcon>

// HRID utilities

/**
 * Check if a chaticon HRID is valid
 */
export function validateChatIconHrid(hrid: string): hrid is ChatIconHrid {
  return hrid in CHATICONS
}

/**
 * Check if a chaticon exists
 */
export function chaticonExists(hrid: string): boolean {
  return hrid in CHATICONS
}

// Getter functions
export function getChatIcon(hrid: ChatIconHrid): ChatIcon {
  return CHATICONS[hrid]
}

export function getAllChatIcons(): ChatIcon[] {
  return Object.values(CHATICONS)
}

export function getChatIconsSortedByIndex(): ChatIcon[] {
  return getAllChatIcons().sort((a, b) => (a.sortIndex || 0) - (b.sortIndex || 0))
}

// Type exports
export type { ChatIcon }
export type { ChatIconHrid }
export type ChatIconId = keyof typeof CHATICONS
export type ChatIconData = typeof CHATICONS
...
// Chat icon groups
export const SPECIAL_CHAT_ICONS = [
  {
    "hrid": "/chat_icons/admin",
    "name": "Admin",
    "isSpecial": true,
...
export const SEASONAL_CHAT_ICONS = [
  {
    "hrid": "/chat_icons/anniversary_purple",
    "name": "Anniversary Purple",
    "isSpecial": false,
...
export const REGULAR_CHAT_ICONS = [
  {
    "hrid": "/chat_icons/abyssal_imp",
    "name": "Abyssal Imp",
    "isSpecial": false,
...
export const PURCHASABLE_CHAT_ICONS = [
  {
    "hrid": "/chat_icons/abyssal_imp",
    "name": "Abyssal Imp",
    "isSpecial": false,
...
// Total count utility
export const TOTAL_CHAT_ICONS = 419
export const TOTAL_SPECIAL_CHAT_ICONS = 9
export const TOTAL_SEASONAL_CHAT_ICONS = 5