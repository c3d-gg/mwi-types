...
export const ItemSchema = z.object({
  ...
  openKeyItemHrid: z.string().optional(),
  enhancementCosts: z.array(z.object({
  itemHrid: z.string(),
  count: z.number()
})).optional(),
  protectionItemHrids: z.array(z.string()).optional(),
  alchemyDetail: z.object({
  bulkMultiplier: z.number(),
  isCoinifiable: z.boolean(),
  decomposeItems: z.array(z.object({
  itemHrid: z.string(),
  count: z.number()
})).nullable(),
  transmuteSuccessRate: z.number(),
  transmuteDropTable: z.array(z.object({
  itemHrid: z.string(),
  dropRate: z.number(),
  minCount: z.number(),
  maxCount: z.number(),
  ...
  combatStyleHrids: z.array(z.string()).optional(),
  ...
  foodHaste: z.number().optional(),
  drinkConcentration: z.number().optional(),
  ...
  miningSpeed: z.number().optional(),
  fishingSpeed: z.number().optional(),
  foragingSpeed: z.number().optional()
}),
  noncombatStats: z.record(z.string(), z.number()),
  combatEnhancementBonuses: z.record(z.string(), z.number()).optional(),
  noncombatEnhancementBonuses: z.record(z.string(), z.number()).optional()
}).optional(),
  consumableDetail: z.object({
  cooldownDuration: z.number(),
  usableInActionTypeMap: z.record(z.string(), z.boolean()).optional(),
  ...
  abilityBookDetail: z.object({
  abilityHrid: z.string(),
  levelRequirements: z.array(z.object({
  skillHrid: z.string(),
  level: z.number()
})),
  experienceGain: z.number().optional()
}).optional()
})
