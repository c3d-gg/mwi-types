...
/**
 * Player Data Generator - Generates types for the complete player state structure.
 *
 ...
 * - Dynamic data (counts, timestamps, IDs)
 */
export class PlayerDataGenerator extends BaseGenerator<PlayerData> {
	constructor() {
		super({
			...
			outputPath: './src/generated/types/player-data.ts',
			generateConstants: false, // No HRID constants needed
			generateUtils: true, // Essential for player state utilities
		})
	}
	...
	protected extractEntities(sourceData: any): Record<string, PlayerData> {
		...
		// We'll use a single key to maintain consistency with BaseGenerator
	...
	protected generateInterfaces(entities: Record<string, PlayerData>): void {
		// Since we're dealing with a single player state object, we need to generate
		// the main interface and all sub-interfaces
		...
		// CommunityBuff interface imported from community-buffs.ts - no need to redefine
	...
	private addImports(): void {
		...
		this.builder.addImport('./actions', ['ActionHrid'], true)
		this.builder.addImport('./abilities', ['AbilityHrid'], true)
		this.builder.addImport('./avatar', ['AvatarHrid'], true)
		this.builder.addImport('./avatars', ['AvatarOutfitHrid'], true)
		this.builder.addImport('./chat-icons', ['ChatIconHrid'], true)
		this.builder.addImport('./name-colors', ['NameColorHrid'], true)
		this.builder.addImport('./game-modes', ['GameModeHrid'], true)
		this.builder.addImport('./house-rooms', ['HouseRoomHrid'], true)
		this.builder.addImport('./buff-types', ['BuffTypeHrid', 'Buff'], true)
		this.builder.addImport('./monsters', ['MonsterHrid', 'CombatDetails'], true)
		this.builder.addImport('./item-locations', ['ItemLocationHrid'], true)
		this.builder.addImport(
			'./community-buffs',
			['CommunityBuffTypeHrid', 'CommunityBuff'],
			true,
		)
		// Note: QuestHrid and UpgradeHrid don't exist yet in game data
	}
	...
	private generateUserInterface(): void {
		...
		this.builder.addInterface('User', properties)
	}
	...
	private generateUserInfoInterface(): void {
		...
		this.builder.addInterface('UserInfo', properties)
	}
	...
	private generateCharacterInterface(): void {
		...
		this.builder.addInterface('Character', properties)
	}
	...
	private generateCharacterInfoInterface(): void {
		...
		this.builder.addInterface('CharacterInfo', properties)
	}
	...
	private generateCharacterSettingInterface(): void {
		...
		this.builder.addInterface('CharacterSetting', properties)
	}
	...
	private generateCharacterSkillInterface(): void {
		...
		this.builder.addInterface('CharacterSkill', properties)
	}
	...
	private generateCharacterItemInterface(): void {
		...
		this.builder.addInterface('CharacterItem', properties)
	}
	...
	private generateCharacterActionInterface(): void {
		...
		this.builder.addInterface('CharacterAction', properties)
	}
	...
	private generateCharacterQuestInterface(): void {
		...
		this.builder.addInterface('CharacterQuest', properties)
	}
	...
	private generateCharacterAbilityInterface(): void {
		...
		this.builder.addInterface('CharacterAbility', properties)
	}
	...
	private generateCharacterLoadoutInterface(): void {
		...
		this.builder.addInterface('CharacterLoadout', properties)
	}
	...
	private generateCharacterHouseRoomInterface(): void {
		...
		this.builder.addInterface('CharacterHouseRoom', properties)
	}
	...
	private generateCharacterUpgradeInterface(): void {
		...
		this.builder.addInterface('CharacterUpgrade', properties)
	}
	...
	private generateGuildInterface(): void {
		...
		this.builder.addInterface('Guild', properties)
	}
	...
	private generateGuildCharacterInterface(): void {
		...
		this.builder.addInterface('GuildCharacter', properties)
	}
	...
	private generateChatMessageInterface(): void {
		...
		this.builder.addInterface('ChatMessage', properties)
	}
	...
	private generateMarketListingInterface(): void {
		...
		this.builder.addInterface('MarketListing', properties)
	}
	...
	private generatePartyInfoInterface(): void {
		...
		this.builder.addInterface('PartyInfo', properties)
	}
	...
	private generateCombatUnitInterface(): void {
		...
		this.builder.addInterface('CombatUnit', properties)
	}
	...
	private generateCombatAbilityInterface(): void {
		...
		this.builder.addInterface('CombatAbility', properties)
	}
	...
	private generateCombatConsumableInterface(): void {
		...
		this.builder.addInterface('CombatConsumable', properties)
	}
	...
	private generateOfflineItemInterface(): void {
		...
		this.builder.addInterface('OfflineItem', properties)
	}
	...
	private generateOfflineSkillInterface(): void {
		...
		this.builder.addInterface('OfflineSkill', properties)
	}
	...
	private generateUserReferralBonusInterface(): void {
		...
		this.builder.addInterface('UserReferralBonus', properties)
	}
	...
	private generateMainPlayerDataInterface(): void {
		...
		this.builder.addInterface('PlayerData', properties)
	}

	// Override the data map generation since we have a single instance
	protected override generateDataMap(
		entities: Record<string, PlayerData>,
	): void {
		// For player data, we don't need a map - it's a single state object
		// The interfaces are already exported by default when created with addInterface
		// No additional data map is needed for this use case
	}

	// Override utilities generation since PlayerData is not a collection
	protected override generateUtilities(
		entities: Record<string, PlayerData>,
	): void {
		// PlayerData is a single state object, not a collection, so we don't need
		// the standard HRID-based utilities like isPlayerDataHrid, getPlayerData, etc.
		// Instead, we'll generate utilities specific to working with player state
		this.generatePlayerStateUtilities()
	}

	private generatePlayerStateUtilities(): void {
